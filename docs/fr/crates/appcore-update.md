...
`appcore-update`: Opaque artifact selection, authenticity, staging, activation, health gate, and rollback.

## Responsabilités

Activation revalidates staged size and SHA-256 and installs immutable build artifacts.
