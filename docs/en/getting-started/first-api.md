...
1. Expose command/query V1 DTOs.
2. Validate payload size before JSON deserialization.
3. Require a single well-formed `Authorization` header.
4. Keep product REST resources outside `appcore-api`.
