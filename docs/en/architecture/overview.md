...
AppCore is organized around a manifest-first host, core runtime, storage contracts, security policy, API transport, scheduler, sync, control plane, peer RPC, supervisor, gateway, and update pipeline.
