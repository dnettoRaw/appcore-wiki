...
This tutorial builds a distributed counter that requires explicit leader and fencing decisions. It keeps the runtime shape visible: command input, idempotency, event output, projection, and manifest/deployment boundaries.
