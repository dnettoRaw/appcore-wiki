...
AppCore est organisé autour d'un hôte manifest-first, du core runtime, des contrats de stockage, de la politique de sécurité, du transport API, du scheduler, de sync, du control plane, de Peer RPC, du supervisor, du gateway et du pipeline d'update.
