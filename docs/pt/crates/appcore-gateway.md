...
`appcore-gateway`: capability de gateway multi-tenant para acesso seguro via Internet sem expor diretamente os workers.

## Responsabilidades

Ele multiplexa tráfego WebSocket/RPC, valida peer tokens de curta duração, roteia por tenant e nunca interpreta payloads opacos de negócio.
