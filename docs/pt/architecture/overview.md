...
AppCore é organizado em torno de um host manifest-first, core runtime, contratos de storage, política de segurança, transporte API, scheduler, sync, control plane, Peer RPC, supervisor, gateway e pipeline de update.
