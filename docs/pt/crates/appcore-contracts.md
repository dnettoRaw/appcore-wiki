...
`appcore-contracts`: Stable, implementation-independent manifests and policies.

## Responsabilidades

Main contracts include `ApplicationManifestV1`, `DeploymentManifestV1`, `RuntimeManifestV1`, runtime modes, capability declarations, and storage/leadership/job/scheduler/health/update policies.
