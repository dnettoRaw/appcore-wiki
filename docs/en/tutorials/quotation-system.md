...
This tutorial builds a quotation workflow with create and accept commands. It keeps the runtime shape visible: command input, idempotency, event output, projection, and manifest/deployment boundaries.
