...
`appcore-types`: Validated IDs, runtime/core identity, compatibility, trace context, and foundational errors.

## Responsabilités

Use these types at contract boundaries instead of unchecked strings.
