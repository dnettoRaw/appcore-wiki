...
This tutorial builds a todo service with create and complete commands. It keeps the runtime shape visible: command input, idempotency, event output, projection, and manifest/deployment boundaries.
