...
O runtime controla ciclo de vida, ordem de dependências, contexto validado, dispatch de command/query, auditoria, health, shutdown e composição de infraestrutura.
