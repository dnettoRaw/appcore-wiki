...
This tutorial builds an offline notes service that can later sync journaled changes. It keeps the runtime shape visible: command input, idempotency, event output, projection, and manifest/deployment boundaries.
