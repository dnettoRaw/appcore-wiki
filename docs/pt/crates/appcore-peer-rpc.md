...
`appcore-peer-rpc`: Authenticated direct peer client, HTTP host, validation, and nonce persistence.

## Responsabilidades

Peer requests bind protocol, tenant, cluster, source, target, expiry, nonce, payload hash, and signature.
