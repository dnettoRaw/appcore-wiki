...
`runtime-console`: Operator-facing inspection and local administrative workflows over runtime/control-plane state.

## Responsabilités

It should expose operational views, not application business screens.
