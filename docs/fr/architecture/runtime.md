...
Le runtime prend en charge cycle de vie, ordre des dépendances, contexte validé, dispatch command/query, audit, health, shutdown et composition d'infrastructure.
