...
package is a dependency-free retirement notice and provides no executable,
host, CLI, compatibility layer, or Runtime behavior.
:::

Use [`appcore-sdk`](/crates/appcore-sdk) for application contracts, canonical
manifests, registration, logging, and opt-in capability namespaces.
