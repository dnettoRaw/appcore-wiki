...
`appcore-capabilities`: Local capability registry and deterministic local/remote provider resolution.

## Responsabilidades

Resolution uses explicit compatibility, health, mode, leadership, and policy.
