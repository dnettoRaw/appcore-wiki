...
Authorization remains application-owned at the domain level, while runtime routes and peer operations enforce declared capability and tenant boundaries.
