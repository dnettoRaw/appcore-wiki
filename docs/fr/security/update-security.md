---
title: Sécurité des updates
sidebar_position: 9
---

# Sécurité des updates

## Introduction

Update security validates application/runtime/protocol identity, checksum, trust, staging size, immutable build paths, and activation health.
